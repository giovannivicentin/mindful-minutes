...
export function MeditationPractice({ locale, duration }: MeditationPracticeProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-8">
      <div className="w-full max-w-md bg-card rounded-lg p-6 shadow-sm">
        <div className="text-xl font-medium mb-4 text-center">{t("practices.meditation.title")}</div>
        ...
        <div className="text-center text-muted-foreground text-sm">
          {locale === "en" ? (
            ...
            <p>Encontre uma posição confortável, feche os olhos e concentre-se na sua respiração.</p>
          )}
        </div>
      </div>
    </div>
