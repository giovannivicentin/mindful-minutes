...
export function TimerSelector({ locale, onSelect }: TimerSelectorProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {!customMode ? (
        <Select value={selectedDuration || undefined} onValueChange={handleSelect}>
        ...
        <div className="flex items-end gap-2">
          ...
          <button onClick={handleCustomSubmit} className="px-4 py-2 bg-primary text-primary-foreground rounded-md">
            {t("common.save")}
          </button>
        </div>
      )}
