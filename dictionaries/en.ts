export const en = {
  ...
  home: {
    ...
    featured: {
      ...
      subtitle:
        "Discover our most popular mindfulness exercises to help you find calm and focus.",
      tryButton: "Try Practice",
    },
    benefits: {
      title: "Benefits of Mindful Minutes",
      subtitle:
        "Just a few minutes each day can make a significant difference in your wellbeing.",
      quick: {
      ...
      stress: {
        title: "Reduce Stress",
        description:
          "Lower cortisol levels and promote a sense of calm and relaxation.",
      },
      focus: {
        title: "Improve Focus",
        description:
          "Train your mind to concentrate better and be more present.",
      },
      energy: {
        title: "Boost Energy",
        description:
          "Prevent burnout and maintain sustainable energy throughout the day.",
      },
    },
    cta: {
      title: "Start Your Mindfulness Journey Today",
      subtitle:
        "Choose from our variety of practices and begin your path to reduced stress and improved wellbeing.",
      button: "Get Started",
    },
  },
  practices: {
    ...
    meditation: {
      ...
      description:
        "Library of audio tracks for focused attention and awareness.",
    },
    visualization: {
    ...
    tratak: {
      ...
      pulsation: "Enable Gentle Pulsation",
      settings: "Settings",
